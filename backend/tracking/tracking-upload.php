...
$tracking_stmt = $db->db_conn->prepare("INSERT INTO tracking (`dated`, `awb`, `forwarding_no`, `courier`, `sender`, `receiver`, `destination`, `content`, `pack`, `wt`, `dwt`, `vendor`, `status`, `ts`, `ts_dated`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
