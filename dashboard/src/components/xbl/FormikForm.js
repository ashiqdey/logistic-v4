    ...
    return (<>
        <div className={`flex fww ${className}`}>
            <Field name={name} {...rest}>
                {
                    ({ field }) => options.map((option, i) => (<Fragment key={i}>
                                <label className={`checkbox ${type}`}>
                                    ...
                                    <div className="tick">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29 29" className="pr z100">
                                            <circle />
                                            <path fill="none" stroke="#075EDD" strokeWidth="2" d="M5.3999023,14.2783203 l4.8852539,6.7744141l13.9477539-10.6259766" />
                                        </svg>
                                    </div>
